...
class simpleKT(nn.Module):
    def __init__(self, n_question, n_pid, 
        ...
        self.out = nn.Sequential(
            nn.Linear(d_model + embed_l + BERT_EMB_DIM,
    ...
    def forward(self, pid_data, q_data, target, id, emb_dic, qtest=False, train=False):
        ...
        if emb_type in ["qid", "qidaktrasch", "qid_scalar", "qid_norasch"]:
            ...
            concat_q = torch.cat([d_output, q_embed_data, bert_embeddings], dim=-1)
